public abstract class RegexLibrary {
    ...
    public static final String MAXVALSTRING = "(?i)(Int(eger)?)?(_|.|-| |:|,)?Max(imum)?(_|.|-| |:|,)?(Int(eger)?)?(_|.|-| |:|,)?(Val(ue)?)?.*";
    public static final String MINVALSTRING = "(?i)(Int(eger)?)?(_|.|-| |:|,)?Min(imum)?(_|.|-| |:|,)?(Int(eger)?)?(_|.|-| |:|,)?(Val(ue)?)?.*";
}
